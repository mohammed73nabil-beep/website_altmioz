...
export default function AboutIndex() {
    ...
    const heroOpacity = pageContentExtras?.['about.hero.image'] ? parseInt(pageContentExtras['about.hero.image']) : 70;
    const ctaOpacity = pageContentExtras?.['about.cta.background'] ? parseInt(pageContentExtras['about.cta.background']) : 90;
        ...
        <div className="bg-background-light dark:bg-background-dark min-h-screen text-gray-800 dark:text-gray-100 font-display selection:bg-primary selection:text-slate-900" dir="rtl" lang="ar" style={{ fontFamily: '"Almarai", "Manrope", sans-serif' }}>
            <SeoHead
                title={pageContents?.['about.hero.title']
                    ...
                    : `من نحن — شريكك الموثوق في تركيب المظلات والسواتر | ${siteName}`}
                description={pageContents?.['about.hero.subtitle']
                    || `${siteName} — مؤسسة هندسية وفنية متخصصة في تركيب مظلات السيارات، مظلات الحدائق، سواتر جدارية، برجولات خشبية وحديدية، وهناجر ومستودعات.`}
            />

            <Navbar />

            {/* 1) HERO SECTION */}
            <section className="relative min-h-[100svh] md:min-h-[600px] flex items-center justify-center overflow-hidden border-b border-primary/20">
                <div className="absolute inset-0 z-0">
                    <img
                         alt="مشاريع مظلات وسواتر كبيرة"
                    ...
                    />
                    <div className="absolute inset-0 bg-surface-dark mix-blend-multiply" style={{ opacity: heroOpacity / 100 }}></div>
                    <div className="absolute inset-0 hero-gradient"></div>
                </div>

                <div className="relative z-10 w-full max-w-5xl mx-auto px-4 text-center mt-24 md:mt-24">
                    <span className="inline-block py-1.5 px-5 rounded-full border border-primary/40 text-primary font-bold text-xs md:text-sm tracking-widest uppercase mb-6 md:mb-8 backdrop-blur-md shadow-lg reveal-on-scroll opacity-0 translate-y-10 transition-all duration-700">
                        نبذة عن الشركة
                    </span>
                    <h1 className="text-4xl md:text-5xl lg:text-7xl font-black text-white mb-6 md:mb-8 leading-tight drop-shadow-2xl reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000 delay-100">
                        {pageContents?.['about.hero.title'] || (
                            <>
                                شريكك الموثوق في المظلات <span className="text-transparent bg-clip-text decoration-gradient">والسواتر</span>
                            </>
                        )}
                    </h1>
                    <p className="text-lg md:text-2xl text-gray-300 mb-8 md:mb-12 max-w-3xl mx-auto leading-relaxed font-light reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000 delay-200">
                        {pageContents?.['about.hero.subtitle'] || 'خبرة فنية وهندسية تضعنا في مقدمة مؤسسات تركيب المظلات والسواتر في المملكة العربية السعودية.'}
                    </p>
                    <div className="reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000 delay-300">
                        <Link href={`${route('contact')}#contact-form-section`} className="w-full sm:w-auto inline-flex items-center justify-center gap-3 decoration-gradient hover:brightness-110 text-slate-900 font-black text-lg md:text-xl py-4 px-8 md:py-4 md:px-12 rounded-xl transition-all duration-300 shadow-[0_10px_30px_rgba(201,162,39,0.3)] hover:-translate-y-1">
            ...
            <section className="py-16 md:py-28 relative bg-white dark:bg-[#040A12] z-20">
                <div className="max-w-4xl mx-auto px-4 text-center reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000">
                    <DynamicIcon name="corporate_fare" className="text-primary text-5xl md:text-6xl mb-6" />
                    <span className="text-primary font-bold tracking-widest text-sm uppercase block mb-3">
                    ...
                    <p className="text-xl text-gray-600 dark:text-gray-300 leading-loose text-justify lg:text-center">
                        {pageContents?.['about.company.paragraph_1'] || 'نحن كيان هندسي وفني متكامل، نمتلك سنوات طويلة من الخبرة في تقديم حلول تركيب المظلات، السواتر، البرجولات، الهناجر، وبيوت الشعر. نعمل وفق منهجية تجمع بين الجمال والمتانة والالتزام الهندسي.'}
                        <br /><br />
                        {pageContents?.['about.company.paragraph_2'] || 'فريقنا يضم نخبة من المهندسين والفنيين والحدادين المهرة الذين يكرسون جهودهم لتركيب وتشييد كافة أعمال التظليل والتغطية بأرقى المعايير.'}
                    </p>
                </div>\
            </section>

            {/* 3) VISION & MISSION SECTION */}
            <section className="py-16 md:py-28 bg-background-light dark:bg-background-dark border-t border-gray-100 dark:border-white/5 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-primary/5 blur-[100px] rounded-full pointer-events-none hidden md:block"></div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="w-full lg:w-1/2 reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000">
                            <div className="relative rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.15)] dark:shadow-none group">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-surface-dark/90 via-[#0B1120]/30 to-transparent"></div>
                                <div className="absolute bottom-6 right-6 left-6 md:bottom-10 md:right-10 md:left-10 text-white">
                                    ...
                                    <div className="w-16 h-1 decoration-gradient rounded-full"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="w-full lg:w-1/2 space-y-12">
                            <div className="reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000 delay-100">
                                <div className="flex items-center gap-4 mb-4">
                                    <span className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-primary/10 flex shrink-0 items-center justify-center text-primary">
                                ...
                                <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed pr-4 md:pl-16">
                                    {pageContents?.['about.vision.text'] || '"أن نكون الخيار الأول والرائد في مجال تركيب المظلات والسواتر والبرجولات والهناجر على مستوى المملكة، وذلك من خلال تقديم حلول تظليل وتغطية عصرية ومستدامة."'}
                                </p>
                            </div>
                            ...
                            <div className="reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000 delay-200">
                                ...
                                <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed pr-4 md:pl-16">
                                    {pageContents?.['about.mission.text'] || '"تقديم خدمات تركيب مظلات وسواتر احترافية بمعايير هندسية وفنية صارمة وجودة لا تضاهى، تضمن رضا العملاء التام وتلتزم بالمواعيد المحددة لبناء وتشييد بيئات خارجية خلابة وآمنة."'}
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-16 md:py-28 relative bg-background-light dark:bg-surface-dark overflow-hidden border-t border-gray-100 dark:border-white/5">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-primary/5 dark:bg-primary/10 blur-[200px] rounded-full mix-blend-screen pointer-events-none hidden md:block"></div>

                <div className="max-w-7xl mx-auto px-4 relative z-10">
                    <div className="text-center mb-16 md:mb-20 reveal-on-scroll opacity-0 translate-y-10 transition-all duration-700">
                        <span className="text-primary font-bold tracking-widest text-sm uppercase block mb-3">ركائز العمل</span>
                        <h2 className="text-3xl md:text-5xl font-black text-gray-900 dark:text-white">قيمنا الأساسية</h2>
                        <div className="w-24 h-1 decoration-gradient mx-auto mt-6 rounded-full"></div>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                        {values.map((val, idx) => (
                            <div key={idx} className="bg-white dark:bg-white/5 backdrop-blur-md p-10 rounded-3xl hover:-translate-y-2 transition-transform duration-500 reveal-on-scroll opacity-0 translate-y-10 border border-gray-100 dark:border-primary/20 group shadow-sm dark:shadow-none" style={{ transitionDelay: `${(idx % 3) * 100}ms` }}>
                                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary to-[#D4AF37] text-slate-900 flex items-center justify-center mb-8 shadow-lg group-hover:scale-110 transition-transform duration-500">
                                    <DynamicIcon name={val.icon} className="text-4xl" />
                                </div>
                                <h4 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{val.title}</h4>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 lg:gap-12 text-center divide-x-0 sm:divide-x-0 md:divide-x md:divide-x-reverse divide-gray-200 dark:divide-white/10">
                        <div className="reveal-on-scroll opacity-0 scale-90 transition-all duration-700 delay-100 mb-6 md:mb-0">
                            <div className="flex justify-center items-center gap-1 text-4xl sm:text-5xl md:text-6xl font-black text-primary mb-2 md:mb-4">
                                <span>+</span>
            ...
            <section className="relative py-20 md:py-32 text-center bg-background-dark overflow-hidden border-t-4 border-primary">
                <div className="absolute inset-0 z-0">
                    ...
                    <div className="absolute inset-0 bg-surface-dark mix-blend-multiply" style={{ opacity: ctaOpacity / 100 }}></div>
                </div>
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-4 reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000">
                    <DynamicIcon name="rocket_launch" className="text-primary text-5xl md:text-6xl mb-6 drop-shadow-lg" />
