...
export default function AboutSection({ data }) {
    return (
        <section className="py-24 relative overflow-hidden bg-background-light dark:bg-background-dark border-t border-gray-100 dark:border-white/5">
            <div className="max-w-7xl mx-auto px-4">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    <div className="w-full lg:w-1/2 min-h-[400px] relative rounded-3xl overflow-hidden shadow-2xl">
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-surface-dark p-8 rounded-3xl shadow-2xl text-center backdrop-blur-sm">
                            <DynamicIcon name="business" className="text-5xl text-primary mb-2" />
                            <h3 className="text-2xl font-black text-gray-900 dark:text-white">خبرة واسعة</h3>
                            <p className="text-primary font-bold mt-1 tracking-wider text-sm">في عالم الديكورات</p>
                        </div>
                    </div>
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col justify-center">
                        ...
                        <div className="flex gap-6 items-center">
                            <Link href={route('services.index')} className="bg-gradient-to-r from-primary to-[#D4AF37] hover:brightness-110 text-slate-900 font-bold py-4 px-10 rounded-xl transition-all shadow-lg hover:-translate-y-1">
                                خدماتنا
                            </Link>
                            <div className="flex items-center gap-3">
                                <DynamicIcon name="support_agent" className="text-primary text-4xl p-3 bg-white dark:bg-surface-dark rounded-full shadow-md" />
                                <div>
