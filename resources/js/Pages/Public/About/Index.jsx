...
export default function AboutIndex() {
    ...
    const team = [
        ...
        },
        {
            ...
            role: pageContents?.['about.team.member2.position'] || 'رئيس قسم الهندسة الميدانية',
        ...
        },
        {
            ...
            role: pageContents?.['about.team.member3.position'] || 'مدير عمليات الكرفانات',
        ...
        },
        {
            ...
            role: pageContents?.['about.team.member4.position'] || 'استشاري العزل والصيانة',
    ...
    return (
        <div className="bg-[#f8f7f6] dark:bg-[#071324] min-h-screen text-gray-800 dark:text-gray-100 font-display selection:bg-[#C9A227] selection:text-[#0B1F3A]" dir="rtl" lang="ar" style={{ fontFamily: '"Almarai", "Manrope", sans-serif' }}>
            <Head>
                <title>{`${pageContents?.['about.hero.title'] || 'من نحن - فخامة الإنجاز'} - ${siteName}`}</title>
            ...
            {/* 1) HERO SECTION */}
            <section className="relative h-[70vh] min-h-[600px] flex items-center justify-center overflow-hidden border-b border-[#C9A227]/20">
                ...
                <div className="relative z-10 w-full max-w-5xl mx-auto px-4 text-center mt-24">
                    <span className="inline-block py-1.5 px-5 rounded-full border border-[#C9A227]/40 text-[#C9A227] font-bold text-sm tracking-widest uppercase mb-8 backdrop-blur-md shadow-lg reveal-on-scroll opacity-0 translate-y-10 transition-all duration-700">
                        نبذة عن الشركة
                    </span>
                    <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-white mb-8 leading-tight drop-shadow-2xl reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000 delay-100">
                        {pageContents?.['about.hero.title'] || (
                            <>
                                شريكك الموثوق في أعمال الصيانة <span className="text-transparent bg-clip-text gold-gradient">والتنفيذ</span>
                            </>
                        )}
                    </h1>
                    <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed font-light reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000 delay-200">
                        {pageContents?.['about.hero.subtitle'] || 'خبرة هندسية وجودة تنفيذ تضعنا في مقدمة مؤسسات الصيانة والبناء في المملكة العربية السعودية ودول الخليج.'}
                    </p>
                    <div className="reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000 delay-300">
                        <Link href={`${route('contact')}#contact-form-section`} className="gold-gradient hover:brightness-110 text-[#0B1F3A] font-black text-xl py-4 px-12 rounded-xl transition-all duration-300 shadow-[0_10px_30px_rgba(201,162,39,0.3)] hover:-translate-y-1 inline-flex items-center gap-3">
            ...
            <section className="py-28 relative bg-white dark:bg-[#040A12] z-20">
                <div className="max-w-4xl mx-auto px-4 text-center reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000">
                    <DynamicIcon name="corporate_fare" className="text-[#C9A227] text-6xl mb-6" />
                    <span className="text-[#C9A227] font-bold tracking-widest text-sm uppercase block mb-3">
                        {pageContents?.['about.company.badge'] || 'نبذة عن الشركة'}
                    </span>
                    <h2 className="text-4xl lg:text-5xl font-black text-gray-900 dark:text-white mb-10 leading-snug">
                    ...
                    <p className="text-xl text-gray-600 dark:text-gray-300 leading-loose text-justify lg:text-center">
                        {pageContents?.['about.company.paragraph_1'] || 'نحن كيان هندسي وفني متكامل، نمتلك سنوات طويلة من الخبرة في تقديم حلول صيانة المباني وتأسيس الهياكل الميدانية من الكرفانات والبركسات. نعمل وفق منهجية صارمة تعتمد على الدقة، الجودة، والتنفيذ الآمن.'}
                        <br /><br />
                        {pageContents?.['about.company.paragraph_2'] || 'فريقنا يضم نخبة من المهندسين والفنيين الذين يكرسون جهودهم لدعم القطاعات السكنية، التجارية، والصناعية، لنرتقي بمستوى الخدمات في المملكة للمنافسة العالمية وتقديم بيئات عمل وسكن تدوم طويلاً.'}
                    </p>
                </div>
            </section>

            {/* 3) VISION & MISSION SECTION */}
            <section className="py-28 bg-[#f8f7f6] dark:bg-[#071324] border-t border-gray-100 dark:border-white/5 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-[#C9A227]/5 blur-[100px] rounded-full pointer-events-none"></div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="w-full lg:w-1/2 reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000">
                            <div className="relative rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.15)] dark:shadow-none group">
                                <img src="https://images.unsplash.com/photo-1504307651254-35680f356dfd?q=80&w=2070&auto=format&fit=crop" alt="Vision and Mission" className="w-full h-[500px] object-cover transition-transform duration-1000 group-hover:scale-105" />
                                <div className="absolute inset-0 bg-gradient-to-t from-[#0B1F3A]/90 via-[#0B1F3A]/30 to-transparent"></div>
                                <div className="absolute bottom-10 right-10 left-10 text-white">
                                    <h3 className="text-3xl font-black mb-3">تطلعات لا تعرف الحدود</h3>
                        ...
                        <div className="w-full lg:w-1/2 space-y-12">
                            <div className="reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000 delay-100">
                                <div className="flex items-center gap-4 mb-4">
                                    <span className="w-12 h-12 rounded-full bg-[#C9A227]/10 flex items-center justify-center text-[#C9A227]">
                                        <DynamicIcon name="visibility" className="text-2xl" />
                                    </span>
                                    <h2 className="text-3xl font-black text-gray-900 dark:text-white">
                                        {pageContents?.['about.vision.title'] || 'رؤيتنا'}
                                    </h2>
                                </div>
                                <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed pl-16">
                                    {pageContents?.['about.vision.text'] || '"أن نكون الخيار الأول والرائد في مجال صيانة المباني وتنفيذ الكرفانات والبركسات على مستوى المملكة، وذلك من خلال تقديم حلول مستدامة تعكس روح الابتكار والتقدم."'}
                                </p>
                            </div>
                            ...
                            <div className="reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000 delay-200">
                                <div className="flex items-center gap-4 mb-4">
                                    <span className="w-12 h-12 rounded-full bg-[#C9A227]/10 flex items-center justify-center text-[#C9A227]">
                                        <DynamicIcon name="flag" className="text-2xl" />
                                    </span>
                                    <h2 className="text-3xl font-black text-gray-900 dark:text-white">
                                ...
                                <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed pl-16">
                                    {pageContents?.['about.mission.text'] || '"تقديم خدمات احترافية بمعايير هندسية صارمة وجودة لا تضاهى، تضمن رضا العملاء التام وتلتزم بأعلى درجات السلامة والمواعيد المحددة لبناء مستقبل عقاري أفضل."'}
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-28 relative bg-[#0B1F3A] overflow-hidden">
                <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-20"></div>
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#C9A227]/10 blur-[200px] rounded-full mix-blend-screen pointer-events-none"></div>

                <div className="max-w-7xl mx-auto px-4 relative z-10">
                    <div className="text-center mb-20 reveal-on-scroll opacity-0 translate-y-10 transition-all duration-700">
                        <span className="text-[#C9A227] font-bold tracking-widest text-sm uppercase block mb-3">ركائز العمل</span>
                        <h2 className="text-4xl md:text-5xl font-black text-white">قيمنا الأساسية</h2>
                        <div className="w-24 h-1 gold-gradient mx-auto mt-6 rounded-full"></div>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                        {values.map((val, idx) => (
                            <div key={idx} className="glass-panel p-10 rounded-3xl hover:-translate-y-2 transition-transform duration-500 reveal-on-scroll opacity-0 translate-y-10 border-t border-[#C9A227]/20 group" style={{ transitionDelay: `${(idx % 3) * 100}ms` }}>
                                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#C9A227] to-[#e3c059] text-[#0B1F3A] flex items-center justify-center mb-8 shadow-lg group-hover:scale-110 transition-transform duration-500">
            ...
            <section id="stats-section" className="py-20 bg-white dark:bg-[#040A12] border-y border-gray-100 dark:border-white/5 relative z-20">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 text-center divide-x-0 lg:divide-x lg:divide-x-reverse divide-gray-200 dark:divide-white/10">
                        <div className="reveal-on-scroll opacity-0 scale-90 transition-all duration-700 delay-100">
                            <div className="flex justify-center items-center gap-1 text-5xl md:text-6xl font-black text-[#C9A227] mb-4">
                                <span>+</span>
                        ...
                        <div className="reveal-on-scroll opacity-0 scale-90 transition-all duration-700 delay-200">
                            <div className="flex justify-center items-center gap-1 text-5xl md:text-6xl font-black text-[#C9A227] mb-4">
                                <span>+</span>
            ...
            {/* 6) TEAM SECTION */}
            <section className="py-28 bg-[#f8f7f6] dark:bg-[#071324]">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="text-center mb-20 reveal-on-scroll opacity-0 translate-y-10 transition-all duration-700">
                        <span className="text-[#C9A227] font-bold tracking-widest text-sm uppercase block mb-3">الكوادر البشرية</span>
                        <h2 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white">فريقنا الهندسي</h2>
                        <div className="w-24 h-1 gold-gradient mx-auto mt-6 rounded-full"></div>
                    </div>
                        ...
                        {team.map((member, idx) => (
                            <div key={member.id} className="group reveal-on-scroll opacity-0 translate-y-10 transition-all duration-700" style={{ transitionDelay: `${idx * 150}ms` }}>
                                <div className="relative rounded-3xl overflow-hidden mb-6 filter grayscale group-hover:grayscale-0 transition-all duration-500 shadow-xl border border-gray-100 dark:border-white/5">
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-t from-[#0B1F3A] to-transparent opacity-80 group-hover:opacity-40 transition-opacity"></div>
                                    <div className="absolute bottom-4 right-4 bg-white/95 dark:bg-[#0B1F3A]/95 backdrop-blur px-4 py-2 rounded-xl border border-white/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 translate-y-4 group-hover:translate-y-0">
                                        <div className="flex gap-2">
                                            <DynamicIcon name="mail" className="text-[#C9A227] text-xl cursor-pointer hover:text-white transition-colors" />
                                            <DynamicIcon name="engineering" className="text-[#C9A227] text-xl cursor-pointer hover:text-white transition-colors" />
                                        </div>
                                    </div>
                                </div>
                                <div className="text-center px-4">
                                    <h3 className="text-2xl font-black text-gray-900 dark:text-white mb-2">{member.name}</h3>
                                    <p className="text-[#C9A227] font-bold">{member.role}</p>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="relative py-32 text-center bg-[#071324] overflow-hidden border-t-4 border-[#C9A227]">
                <div className="absolute inset-0 z-0">
                    ...
                    <div className="absolute inset-0 bg-[#0B1F3A]/90 mix-blend-multiply"></div>
                </div>
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-4 reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000">
                    <DynamicIcon name="rocket_launch" className="text-[#C9A227] text-6xl mb-6 drop-shadow-lg" />
                    ...
                    <Link href={`${route('contact')}#contact-form-section`} className="inline-flex items-center justify-center gap-4 gold-gradient hover:bg-white text-[#0B1F3A] font-black text-2xl py-6 px-16 rounded-2xl transition-all duration-300 shadow-[0_15px_40px_rgba(201,162,39,0.4)] hover:-translate-y-2 hover:shadow-[0_20px_50px_rgba(201,162,39,0.6)] w-full sm:w-auto">
            ...
            <footer className="bg-[#040A12] py-8 border-t border-white/5 relative z-20">
                <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="text-2xl font-black text-white">{siteName}</div>
