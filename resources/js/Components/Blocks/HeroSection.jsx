            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-4 mt-20">
                <div className="max-w-4xl text-right">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mb-16">
                        <Link href={route('contact')} className="bg-gradient-to-r from-primary to-[#D4AF37] hover:brightness-110 text-slate-900 font-bold py-4 px-10 rounded-lg transition-all shadow-[0_10px_30px_rgba(201,162,39,0.3)] hover:-translate-y-1 text-lg text-center">
                            تواصل معنا
                        </Link>
                        <Link href={route('our-projects.index')} className="border border-white/30 hover:bg-white hover:text-slate-900 text-white font-bold py-4 px-10 rounded-lg transition-all backdrop-blur-sm hover:-translate-y-1 text-lg text-center">
                            سجل أعمالنا
                        </Link>
                    </div>
                </div>
