        ...
        <div className="fixed bottom-6 left-6 sm:bottom-8 sm:left-8 z-[100] font-display" dir="rtl">
            ...
            <div className={`flex flex-col gap-3 mb-4 transition-all duration-300 origin-bottom ${isOpen ? 'scale-100 opacity-100' : 'scale-0 opacity-0 pointer-events-none'}`}>
                ...
                <a
                    ...
                    className="w-12 h-12 rounded-full bg-white dark:bg-[#0B1F3A] flex items-center justify-center text-[#25D366] shadow-[0_10px_20px_rgba(0,0,0,0.15)] dark:shadow-2xl border border-gray-100 dark:border-white/10 hover:scale-110 transition-transform hover:bg-[#25D366]/10"
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 rounded-full bg-white dark:bg-[#0B1F3A] flex items-center justify-center text-[#229ED9] shadow-[0_10px_20px_rgba(0,0,0,0.15)] dark:shadow-2xl border border-gray-100 dark:border-white/10 hover:scale-110 transition-transform hover:bg-[#229ED9]/10"
                ...
                <a
                    href={`tel:${cleanPhone}`}
                    className="w-12 h-12 rounded-full bg-white dark:bg-[#0B1F3A] flex items-center justify-center text-[#C9A227] shadow-[0_10px_20px_rgba(0,0,0,0.15)] dark:shadow-2xl border border-gray-100 dark:border-white/10 hover:scale-110 transition-transform hover:bg-[#C9A227]/10"
                    title="اتصل بنا"
                >
            ...
            <button
                ...
                className={`w-16 h-16 rounded-full flex items-center justify-center text-white shadow-[0_10px_30px_rgba(201,162,39,0.4)] transition-all duration-300 hover:scale-110 relative ${isOpen ? 'bg-[#0B1F3A]' : 'bg-[#C9A227] hover:bg-[#e3c059]'}`}
            ...
            >
                ...
                {!isOpen && (
                    <span className="absolute inset-0 rounded-full border-2 border-[#C9A227] animate-ping opacity-50"></span>
                )}
            </button>
        </div>
    );
