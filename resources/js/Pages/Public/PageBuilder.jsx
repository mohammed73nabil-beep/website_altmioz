...
export default function PageBuilder({ pageData }) {
    if (!pageData || !pageData.content) {
        return (
            <div className="bg-[#f8f7f6] dark:bg-[#071324] min-h-screen flex items-center justify-center text-gray-400">
        ...
        <div className="bg-[#f8f7f6] dark:bg-[#071324] min-h-screen text-gray-800 dark:text-gray-100 font-display selection:bg-[#C9A227] selection:text-[#0B1F3A]" dir="rtl" lang="ar" style={{ fontFamily: '"Almarai", "Manrope", sans-serif' }}>
            ...
            <footer className="bg-[#040A12] py-8 border-t border-white/5 relative z-20 mt-auto">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <div className="text-2xl font-black text-white mb-4">صيانة وفخامة المقاولات</div>
                    <p className="text-sm text-gray-500">© 2026 تم التطوير بواسطة نظام باني الصفحات المتقدم.</p>
                </div>
            </footer>
        </div>
    );
